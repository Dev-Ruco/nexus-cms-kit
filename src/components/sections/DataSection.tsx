        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {dataIndicators.map((indicator, index) => {
            ...
            return (
              ...
              >
                <div className="glass rounded-2xl p-6 md:p-8 text-center h-full transition-all duration-300 hover:bg-white/15">
                  {/* Icon */}
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-accent mb-4 group-hover:animate-pulse-glow">
